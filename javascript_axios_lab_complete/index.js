...
const API_KEY = "live_bTSnX965dgdL4Hh0SHpdnMvh7S9VgETvwEQFIZqDmpw8nUYblYNKMUHKRbiYcoC6";
const subId = "user-125";
...
function configInterceptor(config) {
  ...
  console.log(`Request started at ${new Date(config.metadata.startTime).toISOString()}`);
  return config;
}
