...
var API_KEY = "live_bTSnX965dgdL4Hh0SHpdnMvh7S9VgETvwEQFIZqDmpw8nUYblYNKMUHKRbiYcoC6";
var subId = "user-125";
...
} // Populate breeds function
function _fetchBreeds() {
  _fetchBreeds = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var response;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 2:
          ...
          return _context2.abrupt("return", response.status === 200 ? response.data : []);
        case 4:
        case "end":
...
function populateBreeds(breeds) {
  ...
  var defaultOption = createOption("Select a Breed", "");
  breedSelect.appendChild(defaultOption);
  breeds.forEach(function (breed) {
    var option = createOption(breed.name, breed.id);
...
// Handle breed selection function
...
function _handleBreedSelection() {
  _handleBreedSelection = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          _context3.prev = 1;
          _context3.next = 4;
          return fetchBreedInfo(selectedBreedId);
        case 4:
...
function fetchBreedInfo(_x) {
  return _fetchBreedInfo.apply(this, arguments);
} // Display breed info function
function _fetchBreedInfo() {
  _fetchBreedInfo = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(selectedBreedId) {
    var response;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          _context4.next = 2;
          return _axios.default.get("/images/search?breed_ids=".concat(selectedBreedId, "&limit=10"));
        case 2:
          response = _context4.sent;
          return _context4.abrupt("return", response.status === 200 ? response.data : []);
        case 4:
        case "end":
...
function displayBreedInfo(breedInfo) {
  ...
  breedInfo.forEach(function (info) {
    var carouselItem = Carousel.createCarouselItem(info.url, info.breeds[0].name, info.id);
    Carousel.appendCarousel(carouselItem);
    var infoElement = createInfoElement(info.breeds[0]);
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        ...
        case 7:
          ...
          console.error("Error getting favorites:", _context5.t0);
        case 10:
        case "end":
...
function _fetchFavorites() {
  _fetchFavorites = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6() {
    var response;
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        ...
        case 2:
          ...
          return _context6.abrupt("return", response.status === 200 ? response.data : []);
        case 4:
        case "end":
...
function displayFavorites(favourites) {
  ...
  favourites.forEach(function (favourite) {
    var carouselItem = Carousel.createCarouselItem(favourite.image.url, "Favorite", favourite.image_id);
    Carousel.appendCarousel(carouselItem);
  });
  Carousel.start();
}
...
// Axios interceptors
_axios.default.interceptors.request.use(configInterceptor);
_axios.default.defaults.onDownloadProgress = updateProgress;
_axios.default.interceptors.response.use(responseInterceptor);
...
function configInterceptor(config) {
  ...
  console.log("Request started at ".concat(new Date(config.metadata.startTime).toISOString()));
  return config;
}
...
function responseInterceptor(response) {
  ...
  console.log("Response received at ".concat(new Date(endTime).toISOString()));
  console.log("Config data:", response);
  var timeDifference = endTime - response.config.metadata.startTime;
  console.log("Time taken: ".concat(timeDifference, " ms"));
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "15148" + '/');
...
//# sourceMappingURL=/javascript_axios_lab_complete.e31bb0bc.js.map